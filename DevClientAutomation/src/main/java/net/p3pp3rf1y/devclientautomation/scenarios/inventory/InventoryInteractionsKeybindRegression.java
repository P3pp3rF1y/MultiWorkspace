...
public final class InventoryInteractionsKeybindRegression {
	...
	private static void runVanillaTransferKeybindRegression(boolean toStorage, boolean shift) {
		...
		waitForClientScreen("vanilla chest", () -> Minecraft.getInstance().gui.screen() instanceof AbstractContainerScreen<?> screen
	...
	private static void runCraftingPlayerInventorySortKeybindRegression() {
		...
		waitForClientScreen("prepared crafting table", () -> Minecraft.getInstance().gui.screen() instanceof CraftingScreen screen
