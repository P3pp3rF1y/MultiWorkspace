...
public final class RecipeJsonUtil {
    ...
    public static String itemStackJson(ItemStack stack) {
        return "{"
                ...
                + JsonUtil.property("id", BuiltInRegistries.ITEM.getKey(stack.getItem()).toString()) + ","
    ...
    private static String encodedStackJson(ItemStack stack) {
        ...
        return ItemStack.CODEC.encodeStart(minecraft.level.registryAccess().createSerializationContext(JsonOps.INSTANCE), stack)
